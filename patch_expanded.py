...
PATCH_TABLE = [
    ...
    # 트레이너 설명글 (뱅크 1) ─ 각 슬롯은 원본 일본어; 모두 한국어로 교체
    (0x06448, "\x02스태미나연습합니다\x01긴레이스에는\x03스태미나중요합니다\x01\x02나에게연습하세요\x03스태미나4\x08\x09있습니다", 'multiline'),
    (0x06500, "\x02파워연습합니다\x01코스에파워중요합니다\x01\x02나에게연습하세요\x03파워4\x08\x09있습니다", 'multiline'),
    ...
    (0x0660E, bytes([0x1A, 0x20, 0x23, 0x20, 0x2E, 0x20, 0x37, 0x20, 0x42, 0x20, 0x4E, 0x20, 0x03]) + encode_kr("다카노 히로시"), 'multiline'),
]
